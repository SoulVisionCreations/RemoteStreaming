...
var certificate = fs.readFileSync("ssl2/cert1.pem", "utf8");
...
//     response.end();
// });
server.listen(11123, function () {
  console.log(new Date() + " Server is listening on port 11123");
});
...
wsServer.on("request", function (request) {
  ...
  id = request.resourceURL.query.id;
//   websocketid = "12345"
 // type = request.resourceURL.query.type;
// type = "sender";
  
  var connection = request.accept("echo-protocol", request.origin);
  console.log(new Date() + " Connection accepted.");
   connectedClients.push(connection);
  //connectedClientsmap.set(connectionid,connection);
  connection.on("message", function (message) {
    if (message.type === "utf8") {
      ...
      connection.sendUTF("");
      console.log("rec", ct);
      //  var compressed = LZString.compress(message.utf8Data);

      //  console.log("comp",compressed.length);
      //  var decompressed=LZString.decompress(message.utf8Data);
      //  console.log("dec ",decompressed.length);
      //  if (decompressed ==message.utf8Data )
      //     console.log("equal");
      ct++;
    //   ws = connectedClientsmap.get(websocketid + "_receiver");//do not have websocketid here
  ...
  connection.on("close", function (reasonCode, description) {
    ...
    //connectedClientsmap.delete(connectionid);
    connectedClients=[]  
    // connectedClients.forEach((ws, i) => {
    //   if (ws === connection) {
    ...
    //   }
    // });
    // connectedClientsmap.forEach((values,keys)=>{
    //     if(values==connection){connectedClientsmap.delete(keys);
    //     console.log(keys);}
    //   })

    // https.get("https:amanraj.bond:80/close?id="+websocketid, (resp) => {
    //     let data = '';
